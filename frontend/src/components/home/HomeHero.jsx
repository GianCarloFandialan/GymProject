...
function HomeHero() {
  ...
  const [ heroContent, setHeroContent ] = useState(contents.filter(hero => hero.title == "Jumbotron"))
  ...
  return (
    ...
    >
      ...
      />
      <span 
        className="absolute text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-center font-NCLMonsterBeast md:text-4xl lg:text-6xl"
      > 
