function ChangeSuccessAlert({ setSuccessAlert }) {
  return (
    <section className=" items-center">
      <div className="w-full text-green-600 border rounded-lg shadow-xl bg-white">
        <div className="flex items-center justify-between px-6 py-4 mx-auto">
          <div className="flex">
            ...
            <p className="text-sm font-semibold tracking-wide uppercase">
              <strong>Nota:</strong> Contenuto modificato con successo.
            </p>
          </div>
          <button
...
export default ChangeSuccessAlert;
