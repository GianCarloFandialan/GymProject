...
function NewTrainerModalSuccess({ setNewTrainerSuccessModal }) {
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        onClick={() => setNewTrainerSuccessModal(false)}
        ...
        >
          <div className="relative z-10">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => {
                  setNewTrainerSuccessModal(false);
                }}
...
export default NewTrainerModalSuccess;
