...
import RSBDeleteButton from "./RSBDeleteButton";

function RSBConfirmModal({
  setOpenDeleteModal,
  subscriptions,
  setSubscriptions,
  deletingBenefitIndex,
  deletingBenefitContent,
  subscription,
}) {
  return (
    <AnimatePresence>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-center mb-6">
              Sei sicuro di voler eliminare il benfit:
              <span className="block">{deletingBenefitContent}</span>
            </p>
...
export default RSBConfirmModal;
