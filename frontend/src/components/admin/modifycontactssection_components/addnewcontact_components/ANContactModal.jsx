...
import ANContactModalForm from "./ANContactModalForm";

function ANContactModal({
  setOpenModal,
  setContacts,
  contacts,
  setOpenModalSuccess,
      ...
      >
        ...
        >
          <div className="rounded-xl border bg-card text-card-foreground shadow lg:w-[30vw] p-2">
            ...
            {/* FORM PER INSERIRE I DATI DEL NUOVO CONTATTO */}
            {/* SI PASSANO COME PARAMETRI: LA FUNZIONE PER MODIFICARE LO STATO DI QUSTO MODALE, LO STATO PER GESRIRE GLI CONTATTO E LA SUA FUNZIONE RELATIVA, FUNZIONE PER GESTIRE LO STATO CHE GESTISCE IL MODALE NEL CASO DI AGGIUNTA CON SUCCESSO DI UN CONTATTO */}
            <ANContactModalForm
