...
import DContactDeleteButton from "./DContactDeleteButton";

function DContactModal({ setOpenDeleteModal, id, contacts, setContacts }) {
  return (
    <AnimatePresence>
      <motion.div
