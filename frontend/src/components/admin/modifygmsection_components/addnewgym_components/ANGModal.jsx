...
import ANGModalForm from "./ANGModalForm";

function ANGModal({ setOpenModal, setGyms, gyms, setOpenModalSuccess }) {
  return (
    <AnimatePresence>
      <motion.div
          ...
          <div className="rounded-xl border bg-card text-card-foreground shadow lg:w-[30vw] p-2">
            <div className="flex flex-col space-y-1.5 p-6">
              <h3 className="font-semibold leading-none tracking-tight text-white">
                Inserisci i dati della nuova palestra
              </h3>
            </div>

            {/* FORM PER INSERIRE I DATI DELLA NUOVA PALESTRA */}
