        ...
        <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
          ...
          <div className="relative flex items-center bg-black lg:rounded-r-3xl rounded-b-3xl lg:rounded-bl-none">
            ...
            <div className="p-8 sm:p-16 lg:p-24">
              ...
              <p className="mt-4 text-white md:text-2xl">tel: {gym.tel}</p>

              <p className="mt-4 text-white md:text-2xl">
                Indirizzo: {gym.address}
              </p>

              <p className="mt-4 text-white md:text-2xl">Orario: {gym.hours}</p>
            </div>
          </div>
        </div>
      </div>
