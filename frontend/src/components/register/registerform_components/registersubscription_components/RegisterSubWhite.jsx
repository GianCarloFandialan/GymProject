      ...
      <motion.div
        ...
        className={
          selectedSubscription == subscription._id
            ...
            : "bg-gray-100 rounded-xl shadow-2xl md:min-h-[304px] max-w-[75vw] mx-auto"
        }
      >
        <div className="p-6 text-center">
          ...
          <div className="mt-6">
            ...
            <button
              className={
                selectedSubscription == subscription._id
                  ? "flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-black rounded-xl hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:bg-black border-2 border-white"
