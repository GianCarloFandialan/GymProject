function ChatSidebarWelcome(params) {
  return (
    <div className="h-full w-full md:max-w-[calc(100vw_-_40.5vw)] lg:max-w-[calc(100vw_-_27.5vw)] absolute right-0 top-0 flex flex-col items-center justify-center ">
